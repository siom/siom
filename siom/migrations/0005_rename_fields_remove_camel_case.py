...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		db.rename_column('siom_task', 'timeLimitMS', 'time_limit_ms')
		db.rename_column('siom_task', 'memoryLimitMB', 'memory_limit_mb')


	def backwards(self, orm):
		db.rename_column('siom_task', 'time_limit_ms', 'timeLimitMS')
		db.rename_column('siom_task', 'memory_limit_mb', 'memoryLimitMB')
